...
class GoingUp extends Extensions
{
    ...
    /**
     * Register GoingUp extension controls
     *
     * @since 1.0.4
     * 
     * @param object $obj
    ...
    {
        $settings = [];
        $settings['afeb_gup'] = $this->CHelper->get_elementor_settings('afeb_gup');
        $settings['afeb_gup_ic'] = $this->CHelper->get_elementor_settings('afeb_gup_ic');
        $settings['afeb_gup_ttl_sh'] = $this->CHelper->get_elementor_settings('afeb_gup_ttl_sh');
        $settings['afeb_gup_ttl'] = $this->CHelper->get_elementor_settings('afeb_gup_ttl');
