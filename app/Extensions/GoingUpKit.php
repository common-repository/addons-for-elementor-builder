...
class GoingUpKit extends Tab_Base
{
    ...
    protected function register_tab_controls()
    {
        $this->CHelper->add_cnt_sctn($this, 'afeb-stng-ext-gup', esc_html__('Scroll to Top', 'addons-for-elementor-builder'), function ($obj) {
            ...
            $this->CHelper->icn($obj, 'afeb_gup_ic', 'fas fa-angle-up', 'fa-solid', '', 0, 0, $cndtn);
            $this->CHelper->sh_swtchr($obj, 'afeb_gup_ttl_sh', __('Show Title', 'addons-for-elementor-builder'), '', $cndtn);
            $this->CHelper->txt($obj, 'afeb_gup_ttl', esc_html__('Title', 'addons-for-elementor-builder'), esc_html__('Back To Top', 'addons-for-elementor-builder'), esc_html__('e.g. Back To Top', 'addons-for-elementor-builder'), 1, ['afeb_gup' => 'yes', 'afeb_gup_ttl_sh' => 'yes']);
