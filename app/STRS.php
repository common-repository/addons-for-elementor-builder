...
class STRS
{
     ...
     * @return array
     */
    public static function msgs($key = '')
    {
        ...
        return isset($output[$key]) ? esc_html($output[$key]) : false;
    }
     ...
     * @return array
     */
    public static function key_words($index, $lower = true)
    {
        ...
        return isset($output[$index]) ? ($lower ? strtolower($output[$index]) : $output[$index]) : false;
    }
