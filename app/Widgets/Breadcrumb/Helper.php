        ...
        if (!is_home() && !is_front_page() || is_paged()) {
            ...
            if (is_category()) {
                ...
                if (get_post_type() != 'post') {
                    ...
                    if ($options['disable_item_link'] == 'yes') {
                        $output .= '<a>' . (isset($post_type->labels) ? esc_html($post_type->labels->singular_name) : '') . '</a> ' . $delimiter . ' ';
                    } else if (isset($slug['slug']) && trim($slug['slug'])) {
                        $output .= '<a href="' . esc_url($homeLink . '/' . $slug['slug']) . '/">' . (isset($post_type->labels) ?  esc_html($post_type->labels->singular_name) : '') . '</a> ' . $delimiter . ' ';
                    }
