            ...
            <div class="afeb-box-body">
                ...
                <div class="afeb-changelog-list-box">
                    <div class="afeb-changelog-date">
                        <?php esc_html_e('October 15, 2024', 'addons-for-elementor-builder'); ?>
                        <span class="afeb-changelog-version">
                            <?php
                            /* translators: %1$s is replaced with current Plug-in version */
                            echo esc_html(sprintf(__('Version %1$s', 'addons-for-elementor-builder'), AFEB_VERSION));
                            ?>
                        </span>
                    </div>
                    <ul class="afeb-changelog-list">
                        <li>
                            <?php esc_html_e('Fixed : Compatibility with PHP 7.', 'addons-for-elementor-builder'); ?>
                        </li>
                    </ul>
                </div>
                <div class="afeb-space afeb-mr-20"></div>
        ...
        <div class="afeb-col-lg-12 afeb-pd-0 afeb-m-md">
            <div class="afeb-box-section afeb-support-feedback-section">
                ...
                <div class="afeb-box-body">
                    ...
                    <div class="afeb-space afeb-mr-20"></div>
                    <a class="afeb-box-btn afeb-primary-btn" href="<?php echo esc_url(Base::AFEB_URL . '/support'); ?>" target="_blank">
...
<div class="afeb-row">
    ...
    <div class="afeb-col-lg-6">
        <div class="afeb-box-section afeb-give-us-review-section">
            ...
            <div class="afeb-box-body">
                <p class="afeb-col-lg-9 afeb-pd-0">
                    <?php esc_html_e("We are really thankful to you that you have chosen our plugin. If our plugin brings a smile in your face while working, please share your happiness by giving us a 5 starts rating in WordPress Org. It will make us happy and won't take more than 2 mins.", 'addons-for-elementor-builder'); ?>
                </p>
                <div class="afeb-space afeb-mr-20"></div>
                <a class="afeb-box-btn afeb-primary-btn" href="https://wordpress.org/support/plugin/addons-for-elementor-builder/reviews/?filter=5" target="_blank">
