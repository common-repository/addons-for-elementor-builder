        ...
        <div class="afeb-element-search-section afeb-col-lg-4 <?php echo $count > 2 ? 'afeb-mr-top-20' : ''; ?>">
            <div class="afeb-box-section afeb-element-section">
                <div class="afeb-box-header">
                    <img src="<?php echo esc_url($this->assets_url('img/extensions/' . strtolower(str_replace('_', '-', $extension_key)) . '.svg')); ?>" alt="<?php echo (isset($extension['title']) && trim($extension['title'])) ? esc_attr(trim($extension['title'])) : ''; ?>">
